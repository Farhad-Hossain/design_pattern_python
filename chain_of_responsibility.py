...
class AuthenticationHeader(HandlerChain):
    def __init__(self, token, next_header: HandlerChain = None):
...
class ContentTypeHeader(HandlerChain):
    def __init__(self, content_type, next_header: HandlerChain = None):
        super().__init__(next_header)
...
class BodyPayloadHeader(HandlerChain):
    def __init__(self, body, next_header: HandlerChain = None):
        super().__init__(next_header)
        self.body = body
...
if __name__ == '__main__':
    ...
    body_header = BodyPayloadHeader("Body:")
